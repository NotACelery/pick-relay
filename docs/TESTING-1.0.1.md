# Pick Relay 1.0.1 — Final regression checklist
...
- [ ] JAR generado como `pickrelay-1.21.1-1.0.1.jar`.
...
- [ ] En altura reducida con ancho suficiente, el inventario se mueve a la derecha de la queue.
- [ ] En layout lateral, Selected Tool y los controles permanecen debajo de ambas grillas y dentro de pantalla.
